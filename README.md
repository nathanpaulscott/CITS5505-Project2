 ...
 * minor fixes: when a quiz is submitted, show "success" popup and redirect to student summary; when time runs out on a quiz, auto-submit and redirect to student summary
